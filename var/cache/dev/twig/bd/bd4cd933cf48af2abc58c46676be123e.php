...
\t\t";
        // line 52
        if (twig_test_empty((isset($context["parteners"]) || array_key_exists("parteners", $context) ? $context["parteners"] : (function () { throw new RuntimeError('Variable "parteners" does not exist.', 52, $this->source); })()))) {
            // line 53
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["parteners"]) || array_key_exists("parteners", $context) ? $context["parteners"] : (function () { throw new RuntimeError('Variable "parteners" does not exist.', 57, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["partener"]) {
            // line 58
            echo "\t\t\t";
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["partener"], "dates", [], "any", false, false, false, 58))) {
                // line 59
...
\t\t\t\t\t\t";
                // line 62
                echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, twig_get_attribute($this->env, $this->source, $context["partener"], "dates", [], "any", false, false, false, 62), "short", "none", "", null, "gregorian", "fr"), "html", null, true);
                echo "</p>
\t\t\t\t</div>
\t\t\t";
            }
...
\t\t\t\t<h2>";
            // line 66
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["partener"], "title", [], "any", false, false, false, 66), "html", null, true);
            echo "</h2>
\t\t\t\t<p>";
            // line 67
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["partener"], "description", [], "any", false, false, false, 67), "html", null, true);
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["partener"], "link", [], "any", false, false, false, 67))) {
                // line 68
                echo "\t\t\t\t\t<a id=\"link_offers_db\" href=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["partener"], "link", [], "any", false, false, false, 68), "html", null, true);
...
";
    ...
    {
        return array (  218 => 72,  211 => 70,  205 => 68,  202 => 67,  198 => 66,  195 => 65,  189 => 62,  184 => 59,  181 => 58,  177 => 57,  174 => 56,  167 => 53,  165 => 52,  128 => 18,  123 => 16,  118 => 14,  113 => 11,  103 => 10,  90 => 7,  80 => 6,  60 => 3,  37 => 1,);
    }
...
\t\t\t\t\t<a id=\"link_offers_db\" href=\"{{partener.link}}\"> lien vers le partenaire</a>.</p>
\t\t\t\t{% endif %}
\t\t\t</div>
\t\t{% endfor %}
    </main>
