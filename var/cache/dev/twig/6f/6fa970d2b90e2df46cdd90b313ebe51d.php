...
class __TwigTemplate_90a632b719de54922ce5eb0d81fca7b1 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 51
        if (twig_test_empty((isset($context["tickets"]) || array_key_exists("tickets", $context) ? $context["tickets"] : (function () { throw new RuntimeError('Variable "tickets" does not exist.', 51, $this->source); })()))) {
            // line 52
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["tickets"]) || array_key_exists("tickets", $context) ? $context["tickets"] : (function () { throw new RuntimeError('Variable "tickets" does not exist.', 56, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["ticket"]) {
            // line 57
            echo "\t\t\t";
            if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["ticket"], "dates", [], "any", false, false, false, 57))) {
                // line 58
...
\t\t\t\t\t";
                // line 61
                echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, twig_get_attribute($this->env, $this->source, $context["ticket"], "dates", [], "any", false, false, false, 61), "short", "none", "", null, "gregorian", "fr"), "html", null, true);
                echo "</p>
\t\t\t\t</div>
\t\t\t";
            }
...
\t\t\t\t<h2>";
            // line 65
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ticket"], "title", [], "any", false, false, false, 65), "html", null, true);
            echo "</h2>
\t\t\t\t<p>";
            // line 66
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ticket"], "description", [], "any", false, false, false, 66), "html", null, true);
            echo "
\t\t\t\t";
            // line 67
            if ( !twig_test_empty($context["ticket"])) {
                ...
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["ticket"], "link", [], "any", false, false, false, 68), "html", null, true);
...
\t\t\t\t\t<a id=\"link_offers_db\" href=\"{{ticket.link}}\"> lien vers le partenaire</a>.</p>
\t\t\t\t{% endif %}
\t\t\t</div>
\t\t{% endfor %}
    </main>
